# openclaw-memory-core: Trust Register
...
| Property | Status | Last Verified | Agent | Notes |
|----------|--------|---------------|-------|-------|
| Exports are stable and typed | untested | - | - | |
| Redaction logic works correctly | untested | - | - | |
| Local store read/write works | untested | - | - | |
| Embeddings interface usable | untested | - | - | |
